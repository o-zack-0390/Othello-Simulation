...
#   start_f_normal_s2  : (通常ダメージ, 固定, 最小値)
    start_f_normal_s2  = models.IntegerField(blank=False, null=False)

#   upper_f_normal_s2  : (通常ダメージ, 固定, 上昇値)
    upper_f_normal_s2  = models.IntegerField(blank=False, null=False)

#   end_f_normal_s2    : (通常ダメージ, 固定, 最大値)
    end_f_normal_s2    = models.IntegerField(blank=False, null=False)

#   start_m_normal_s2  : (通常ダメージ, 倍率, 最小値)
    start_m_normal_s2  = models.DecimalField(blank=False, null=False)

#   upper_m_normal_s2  : (通常ダメージ, 倍率, 上昇値)
    upper_m_normal_s2  = models.DecimalField(blank=False, null=False)

#   end_m_normal_s2    : (通常ダメージ, 倍率, 最大値)
    end_m_normal_s2    = models.DecimalField(blank=False, null=False)

#   is_shield_pass_s2  : 貫通スキルか判定
    is_shield_pass_s2  = models.BooleanField(blank=False, null=False)

#   start_f_special_s2 : (特殊ダメージ, 固定, 最小値)
    start_f_special_s2 = models.IntegerField(blank=False, null=False)

#   upper_f_special_s2 : (特殊ダメージ, 固定, 上昇値)
    upper_f_special_s2 = models.IntegerField(blank=False, null=False)

#   end_f_special_s2   : (特殊ダメージ, 固定, 最大値)
    end_f_special_s2   = models.IntegerField(blank=False, null=False)

#   start_m_special_s2 : (特殊ダメージ, 倍率, 最小値)
    start_m_special_s2 = models.DecimalField(blank=False, null=False)

#   upper_m_special_s2 : (特殊ダメージ, 倍率, 上昇値)
    upper_m_special_s2 = models.DecimalField(blank=False, null=False)

#   end_m_special_s2   : (特殊ダメージ, 倍率, 最大値)
    end_m_special_s2   = models.DecimalField(blank=False, null=False)
